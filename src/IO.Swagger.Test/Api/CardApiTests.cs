...
namespace IO.Swagger.Test
{
    ...
    public class CardApiTests
    {
        ...
        public void CardGetTest()
        {
            ...
            //string satisfy = null;
            //var response = instance.CardGet(exclude, include, order, page, transform, columns, filter, satisfy);
        ...
        /// </summary>
        [Test]
        public void CardIdDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.CardIdDelete(id);
        ...
        /// </summary>
        [Test]
        public void CardIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.CardIdGet(id);
        ...
        /// </summary>
        [Test]
        public void CardIdPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //Item17 item = null;
            //var response = instance.CardIdPatch(id, item);
            //Assert.IsInstanceOf<int?> (response, "response is int?");
        }
        ...
        /// </summary>
        [Test]
        public void CardIdPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //Item16 item = null;
            //var response = instance.CardIdPut(id, item);
            //Assert.IsInstanceOf<int?> (response, "response is int?");
        }
        ...
        /// </summary>
        [Test]
        public void CardPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Item15 item = null;
            //var response = instance.CardPost(item);
            //Assert.IsInstanceOf<int?> (response, "response is int?");
        }
