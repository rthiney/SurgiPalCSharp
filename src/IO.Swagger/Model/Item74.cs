...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item74 :  IEquatable<Item74>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item74" /> class.
        /// </summary>
        ...
        public Item74(int? Id = null, int? StateId = null, int? CountryId = null, string Name = null, string Email = null, string Address = null, string Suite = null, string City = null, string StateTyped = null, string PostalCode = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item74 and cannot be null");
            }
            else
            {
                this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item74);
        }

        /// <summary>
        /// Returns true if Item74 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item74 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item74 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
