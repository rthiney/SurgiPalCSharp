...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item3 :  IEquatable<Item3>, IValidatableObject
    {
        /// <summary>
        ...
        public Item3(int? Id = null, int? FosUserId = null, int? SuggestingHospitalId = null, int? QuestionId = null, int? AnswersBoxId = null, string Reply = null, string CreatedAt = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item3 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item3 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item3);
        }

        /// <summary>
        /// Returns true if Item3 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item3 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
