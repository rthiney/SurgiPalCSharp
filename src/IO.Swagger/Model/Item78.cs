...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item78 :  IEquatable<Item78>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item78" /> class.
        /// </summary>
        ...
        public Item78(int? Id = null, string Text = null, string Placeholder = null, int? ClusterId = null, int? QuestionTypeId = null, int? Active = null, int? Required = null, int? Position = null, string Options = null, int? Indent = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item78 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Active == null)
            {
                throw new InvalidDataException("Active is a required property for Item78 and cannot be null");
            }
            else
            {
                this.Active = Active;
            ...
            if (Required == null)
            {
                throw new InvalidDataException("Required is a required property for Item78 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item78);
        }

        /// <summary>
        /// Returns true if Item78 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item78 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item78 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
