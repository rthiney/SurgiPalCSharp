...
namespace IO.Swagger.Model
{
    ...
    public partial class Item :  IEquatable<Item>, IValidatableObject
    {
        ...
        public Item(int? Id = null, int? FosUserId = null, int? QuestionId = null, int? AnswersBoxId = null, string Reply = null, string CreatedAt = null, string UpdatedAt = null)
        {
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item and cannot be null");
            }
            else
            {
            ...
            if (UpdatedAt == null)
            {
                throw new InvalidDataException("UpdatedAt is a required property for Item and cannot be null");
            }
            else
            {
