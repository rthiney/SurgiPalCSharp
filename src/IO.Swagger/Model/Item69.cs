...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item69 :  IEquatable<Item69>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item69" /> class.
        /// </summary>
        ...
        public Item69(int? Id = null, int? UserId = null, string Subject = null, string Message = null, string CreatedAt = null, int? Viewed = null, int? SenderId = null, int? DoctorDataId = null, int? HospitalDataId = null, string Email = null, string DoctorName = null, string DoctorImage = null, string HospitalName = null, string HospitalEmail = null)
        {
            // to ensure "Subject" is required (not null)
            if (Subject == null)
            {
                throw new InvalidDataException("Subject is a required property for Item69 and cannot be null");
            }
            else
            {
            ...
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for Item69 and cannot be null");
            }
            else
            {
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item69 and cannot be null");
            }
            else
            {
            ...
            if (Viewed == null)
            {
                throw new InvalidDataException("Viewed is a required property for Item69 and cannot be null");
            }
            else
            {
                this.Viewed = Viewed;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item69);
        }

        /// <summary>
        /// Returns true if Item69 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item69 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item69 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
