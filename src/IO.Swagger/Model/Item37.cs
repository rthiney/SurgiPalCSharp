...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item37 :  IEquatable<Item37>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item37" /> class.
        /// </summary>
        ...
        public Item37(int? HospitalId = null, int? DoctorId = null)
        {
            // to ensure "HospitalId" is required (not null)
            if (HospitalId == null)
            {
                throw new InvalidDataException("HospitalId is a required property for Item37 and cannot be null");
            }
            else
            {
            ...
            if (DoctorId == null)
            {
                throw new InvalidDataException("DoctorId is a required property for Item37 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item37);
        }

        /// <summary>
        /// Returns true if Item37 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item37 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item37 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
