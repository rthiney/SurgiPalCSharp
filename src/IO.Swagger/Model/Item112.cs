...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item112 :  IEquatable<Item112>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item112" /> class.
        /// </summary>
        ...
        public Item112(int? Id = null, int? StateId = null, string CompanyName = null, string Name = null, string Address = null, string Suite = null, string City = null, string StateTyped = null, string PostalCode = null, string Phone = null, string UserRole = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item112 and cannot be null");
            }
            else
            {
                this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item112);
        }

        /// <summary>
        /// Returns true if Item112 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item112 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item112 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
