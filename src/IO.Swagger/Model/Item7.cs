...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item7 :  IEquatable<Item7>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item7" /> class.
        /// </summary>
        ...
        public Item7(int? Id = null, int? CardId = null, int? DoctorId = null, int? RespondentId = null, string Name = null, string CreatedAt = null, int? HospitalId = null, int? ParentSnapshotId = null, int? SurgerySnapshot = null, string Cpt = null, string DiagnosisCode = null, string SurgeryTime = null, string AdmissionStatus = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item7 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item7 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item7);
        }

        /// <summary>
        /// Returns true if Item7 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item7 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item7 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
