...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item38 :  IEquatable<Item38>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item38" /> class.
        /// </summary>
        ...
        public Item38(int? HospitalId = null, int? DoctorId = null)
        {
            // to ensure "HospitalId" is required (not null)
            if (HospitalId == null)
            {
                throw new InvalidDataException("HospitalId is a required property for Item38 and cannot be null");
            }
            else
            {
            ...
            if (DoctorId == null)
            {
                throw new InvalidDataException("DoctorId is a required property for Item38 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item38);
        }

        /// <summary>
        /// Returns true if Item38 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item38 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item38 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
