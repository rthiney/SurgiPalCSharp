...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item70 :  IEquatable<Item70>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item70" /> class.
        /// </summary>
        ...
        public Item70(int? Id = null, int? UserId = null, string Subject = null, string Message = null, string CreatedAt = null, int? Viewed = null, int? SenderId = null, int? DoctorDataId = null, int? HospitalDataId = null, string Email = null, string DoctorName = null, string DoctorImage = null, string HospitalName = null, string HospitalEmail = null)
        {
            // to ensure "Subject" is required (not null)
            if (Subject == null)
            {
                throw new InvalidDataException("Subject is a required property for Item70 and cannot be null");
            }
            else
            {
            ...
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for Item70 and cannot be null");
            }
            else
            {
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item70 and cannot be null");
            }
            else
            {
            ...
            if (Viewed == null)
            {
                throw new InvalidDataException("Viewed is a required property for Item70 and cannot be null");
            }
            else
            {
                this.Viewed = Viewed;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item70);
        }

        /// <summary>
        /// Returns true if Item70 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item70 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item70 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
