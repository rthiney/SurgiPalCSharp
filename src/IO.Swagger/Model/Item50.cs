...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item50 :  IEquatable<Item50>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item50" /> class.
        /// </summary>
        ...
        public Item50(int? Id = null, int? DoctorDataId = null, int? HospitalDataId = null, string Username = null, string UsernameCanonical = null, string Email = null, string EmailCanonical = null, int? Enabled = null, string Salt = null, string Password = null, string LastLogin = null, int? Locked = null, int? Expired = null, string ExpiresAt = null, string ConfirmationToken = null, string PasswordRequestedAt = null, string Roles = null, int? CredentialsExpired = null, string CredentialsExpireAt = null, int? PracticeId = null, string ActivationToken = null, int? VendorDataId = null, int? StaffOfId = null)
        {
            ...
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("UsernameCanonical is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for Item50 and cannot be null");
            }
            else
            {
                this.Email = Email;
            ...
            {
                throw new InvalidDataException("EmailCanonical is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            if (Enabled == null)
            {
                throw new InvalidDataException("Enabled is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            if (Salt == null)
            {
                throw new InvalidDataException("Salt is a required property for Item50 and cannot be null");
            }
            else
            {
                this.Salt = Salt;
            ...
            if (Password == null)
            {
                throw new InvalidDataException("Password is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            if (Locked == null)
            {
                throw new InvalidDataException("Locked is a required property for Item50 and cannot be null");
            }
            else
            {
                this.Locked = Locked;
            ...
            if (Expired == null)
            {
                throw new InvalidDataException("Expired is a required property for Item50 and cannot be null");
            }
            else
            {
            ...
            if (Roles == null)
            {
                throw new InvalidDataException("Roles is a required property for Item50 and cannot be null");
            }
            else
            {
                this.Roles = Roles;
            ...
            {
                throw new InvalidDataException("CredentialsExpired is a required property for Item50 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item50);
        }

        /// <summary>
        /// Returns true if Item50 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item50 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item50 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
