...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item6 :  IEquatable<Item6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item6" /> class.
        /// </summary>
        ...
        public Item6(int? Id = null, int? CardId = null, int? DoctorId = null, int? RespondentId = null, string Name = null, string CreatedAt = null, int? HospitalId = null, int? ParentSnapshotId = null, int? SurgerySnapshot = null, string Cpt = null, string DiagnosisCode = null, string SurgeryTime = null, string AdmissionStatus = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item6 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item6 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item6);
        }

        /// <summary>
        /// Returns true if Item6 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item6 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
