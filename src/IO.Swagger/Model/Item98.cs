...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item98 :  IEquatable<Item98>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item98" /> class.
        /// </summary>
        ...
        public Item98(int? Id = null, int? DoctorId = null, int? SpecialtyId = null, int? AnswerBoxId = null, int? SurgeryStatusId = null, string Patient = null, string Ssn = null, string Term = null, string CreatedAt = null, string Reschedules = null, int? Cancelled = null, string Cpt = null, int? Completed = null, string Initials = null, string DiagnosisCode = null, int? HospitalId = null, string SurgeryTime = null, string AdmissionStatus = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item98 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Patient == null)
            {
                throw new InvalidDataException("Patient is a required property for Item98 and cannot be null");
            }
            else
            {
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item98 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item98);
        }

        /// <summary>
        /// Returns true if Item98 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item98 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item98 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
