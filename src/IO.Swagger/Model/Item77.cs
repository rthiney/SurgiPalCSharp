...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item77 :  IEquatable<Item77>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item77" /> class.
        /// </summary>
        ...
        public Item77(int? PracticeId = null, int? HospitalId = null)
        {
            // to ensure "PracticeId" is required (not null)
            if (PracticeId == null)
            {
                throw new InvalidDataException("PracticeId is a required property for Item77 and cannot be null");
            }
            else
            {
            ...
            if (HospitalId == null)
            {
                throw new InvalidDataException("HospitalId is a required property for Item77 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item77);
        }

        /// <summary>
        /// Returns true if Item77 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item77 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item77 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
