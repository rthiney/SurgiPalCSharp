...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item5 :  IEquatable<Item5>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item5" /> class.
        /// </summary>
        ...
        public Item5(int? Id = null, int? FosUserId = null, int? SuggestingHospitalId = null, int? QuestionId = null, int? AnswersBoxId = null, string Reply = null, string CreatedAt = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item5 and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Item5 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item5);
        }

        /// <summary>
        /// Returns true if Item5 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item5 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
