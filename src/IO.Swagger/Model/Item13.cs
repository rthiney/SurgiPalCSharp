...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Item13 :  IEquatable<Item13>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Item13" /> class.
        /// </summary>
        ...
        public Item13(int? Id = null, int? AnswerBoxId = null, string Name = null, string File = null)
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Item13 and cannot be null");
            }
            else
            {
                this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Item13);
        }

        /// <summary>
        /// Returns true if Item13 instances are equal
        /// </summary>
        /// <param name="other">Instance of Item13 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item13 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
